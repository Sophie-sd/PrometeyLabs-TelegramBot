...
class ZenEduClient:
    ...
    async def get_products(self) -> List[Dict[str, Any]]:
        ...
        В демо-режимі повертає фейкові дані
        """
        try:
            if self.demo_mode:
                # Демо-курси для тестування
                demo_products = [
                    {
                        'id': 'course_1',
                        'name': 'Основи Python програмування',
                        'title': 'Основи Python програмування',
                        'price': 1500,
                        'description': 'Повний курс Python з нуля до професіонала. Включає практичні завдання та проекти.',
                        'access_link': 'https://zenedu.io/course/python-basics'
                    },
                    {
                        'id': 'course_2', 
                        'name': 'Telegram Bot розробка',
                        'title': 'Telegram Bot розробка',
                        'price': 2500,
                        'description': 'Створюємо професійних Telegram ботів за допомогою Python та aiogram.',
                        'access_link': 'https://zenedu.io/course/telegram-bots'
                    },
                    {
                        'id': 'course_3',
                        'name': 'Веб-дизайн з Figma',
                        'title': 'Веб-дизайн з Figma',
                        'price': 1200,
                        'description': 'Вивчаємо сучасний веб-дизайн, створюємо макети в Figma.',
                        'access_link': 'https://zenedu.io/course/web-design'
                    }
                ]
                
                await asyncio.sleep(0.3)  # Імітація мережевого запиту
                logger.info(f"📚 Демо: отримано {len(demo_products)} продуктів")
