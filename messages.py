...
# Блок "Курси"
COURSES_MAIN_MESSAGE = """📚 Курси від PrometeyLabs — це максимум практики, мінімум води і підтримка на кожному кроці.
...
👀 Оберіть курс нижче, щоб дізнатися більше."""

COURSES_LOADING_MESSAGE = """🔄 Завантаження курсів з ZenEdu...

⏳ Отримуємо актуальний список курсів з платформи.
Це може зайняти кілька секунд."""

COURSES_LOADED_MESSAGE = """✅ Синхронізація завершена!

📚 Курси успішно завантажені з ZenEdu.
Тепер ви можете переглядати та купувати курси!"""

COURSES_ERROR_MESSAGE = """❌ Помилка синхронізації

Не вдалося завантажити курси з ZenEdu.
Спробуйте пізніше або зверніться до підтримки @PrometeyLabs."""

NO_COURSES_MESSAGE = """📚 Курси від PrometeyLabs — це максимум практики, мінімум води і підтримка на кожному кроці.
...
Натисніть кнопку "Завантажити курси" для синхронізації з платформою."""
