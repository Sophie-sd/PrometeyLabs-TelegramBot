    ...
    try:
        if action == "main":
            ...
            if not courses:
                ...
                await callback.message.edit_text(
                    "📚 Курси від PrometeyLabs — це максимум практики, мінімум води і підтримка на кожному кроці.\n\n"
                    "🔄 Курси ще не завантажені з ZenEdu платформи.\n\n"
                    "Що вас чекає після завантаження:\n"
                    "✅ Практичні відеоуроки\n"
                    "✅ Зрозуміла документація\n"
                    "✅ Домашні завдання, щоб одразу застосовувати знання\n"
                    "✅ Наставник 24/7 — завжди на звʼязку\n"
                    "✅ І ще 🎁 приємний бонус для всіх, хто проходить курси до кінця\n\n"
                    "Натисніть кнопку нижче для синхронізації:",
                    reply_markup=keyboard,
                    parse_mode="Markdown"
                )
